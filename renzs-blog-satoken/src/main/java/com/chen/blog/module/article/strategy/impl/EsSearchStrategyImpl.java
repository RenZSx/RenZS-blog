package com.chen.blog.module.article.strategy.impl;

import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.chen.blog.common.constant.CommonConst;
import com.chen.blog.common.enums.ArticleStatusEnum;
import com.chen.blog.module.article.dto.ArticleSearchDTO;
import com.chen.blog.module.article.strategy.SearchStrategy;
...
public class EsSearchStrategyImpl implements SearchStrategy {
    ...
    private NativeSearchQueryBuilder buildQuery(String keywords) {
        ...
        boolQueryBuilder.must(QueryBuilders.boolQuery().should(QueryBuilders.matchQuery("articleTitle", keywords))
                ...
                .must(QueryBuilders.termsQuery("status", Arrays.asList(ArticleStatusEnum.PUBLIC.getStatus(), ArticleStatusEnum.RECOMMEND.getStatus())));
