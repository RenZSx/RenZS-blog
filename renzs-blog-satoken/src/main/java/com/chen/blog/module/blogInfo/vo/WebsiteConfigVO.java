package com.chen.blog.module.blogInfo.vo;
...
public class WebsiteConfigVO {
     ...
     * 底部诗句
     */
    @ApiModelProperty(name = "websiteVerse", value = "底部诗句", required = true, dataType = "String")
    private String websiteVerse;
    /**
     * 网站备案号
     */
     ...
     * 公安备案号
     */
    @ApiModelProperty(name = "websitePoliceRecordNo", value = "网站公安备案号", required = true, dataType = "String")
    private String websitePoliceRecordNo;
    /**
     * 公安备案号
     */
    @ApiModelProperty(name = "websiteBgAddress", value = "后台地址", required = true, dataType = "String")
    private String websiteBgAddress;
    /**
     * 社交登录列表
     */
     ...
     * 是否开启邮箱注册
     */
    @ApiModelProperty(name = "isEmailRegister", value = "是否开启邮箱注册", required = true, dataType = "Integer")
