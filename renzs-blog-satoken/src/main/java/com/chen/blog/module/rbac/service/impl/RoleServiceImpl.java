...
import com.chen.blog.module.user.dto.UserRoleDTO;
import com.chen.blog.common.exception.BizException;
import com.chen.blog.common.satoken.ResourceRoleCache;
import com.chen.blog.module.rbac.service.RoleMenuService;
import com.chen.blog.module.rbac.service.RoleResourceService;
import com.chen.blog.module.rbac.service.RoleService;
...
import com.chen.blog.module.user.dto.RoleDTO;
import com.chen.blog.module.rbac.entity.Role;
import com.chen.blog.module.rbac.entity.RoleMenu;
...
import com.chen.blog.module.rbac.vo.RoleVO;
...
public class RoleServiceImpl extends ServiceImpl<RoleDao, Role> implements RoleService {
    ...
    public void saveOrUpdateRole(RoleVO roleVO) {
        ...
        if (Objects.nonNull(roleVO.getResourceIdList())) {
            ...
            // 角色-资源映射变更后,刷新 sa-token 拦截器使用的缓存
